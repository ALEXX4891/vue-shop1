          ...
          <li class="colors__item" v-for="el in colors" :key="el.id">
            <label class="colors__label">
              <input
                ...
                />
                <!-- передача цвета в спан: -->
                <span class="colors__value" :style="`background-color: ${ el.code }`" :value="el.id"> </span>
            </label>
          </li>
        </ul>
      </fieldset>
...
export default {
  ...
  computed: {
    // можно применить геттер и сеттер для обновления данных на лету :
    // currentPriceFrom: {
    //   get() {
  ...
  watch: {
    // вотчеры слядят за изменением данных
    priceFrom(value) {
  ...
  methods: {
    // метод обновления данных при нажатии кнопки отправить
    submit() {
    ...
    // метод обнуления данных при нажатии кнопки сбросить
    reset() {
