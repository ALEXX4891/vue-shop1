...
<template>
  <div>
    ...
    <main class="content container" v-else-if="!productData">Произошла ошибка при загрузке товара...
            ...
            <div class="item__form">
              <form class="form" action="#" method="POST" @submit.prevent="addToCart">
                ...
                <fieldset class="form__block">
                  ...
                  <ul class="colors">
                    <li class="colors__item" v-for="el in product.colors" :key="el.id">
                      <label class="colors__label">
                        <input class="colors__radio sr-only" type="radio" name="color-item" :value="el.id" checked="">
                        <span class="colors__value" :style="`background-color: ${ el.code }`" :value="el.id">
                        </span>
                      </label>
                    </li>
                  </ul>
                ...
                <div class="item__row">
                  <plusMinus v-model="productAmount" :productAmount="productAmount"/>
...
export default {
  ...
  computed: {
    ...
    // productAmount() {
    //   return plusMinus.data.productAmount;
    // },
  },
  methods: {
    ...mapActions(['addProductToCart']), // проксирование действия из глобального хранилища store в методы данного компонента
  ...
  watch: {
    '$route.params.id': {
      ...
      immediate: true, // заменяет хук "created"
    },
  },
};
</script>
